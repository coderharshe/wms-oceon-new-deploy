  ...
  return (
    <div className="mx-auto max-w-5xl space-y-3">
      <div className="flex flex-wrap items-center justify-between gap-2">
        ...
        <Link className="btn" href="/billing/gst-bill">New GST invoice</Link>
      </div>
                        ...
                        <div className="flex flex-wrap justify-end gap-1">
                          ...
                          {isReplayable(r) ? (
                            <>
                              ...
                              {!r.supersededBy && (
                                <Link className="btn" href={`/billing/gst-bill?revise=${encodeURIComponent(r.invoiceNo)}`}>Modify</Link>
                              )}
                            </>
                          ) : (
